...
words = {"people","sites","things","packs","function","adj","badsoft","drama","crash","ban","code","worse","ac1","price","activates","says","enormous"}

--print(sentence[1])
for i=1, #sentence do
  str = sentence[i]
  for j=1, #words do 
    str,n = string.gsub(str, "%["..words[j].."]", "[Get("..words[j]..")]")
  end
